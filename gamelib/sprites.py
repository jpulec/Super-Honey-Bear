    ...
    def on_collision(self, side, sprite, group):
        ...
        if side == TOP_SIDE:
            ...
            if isinstance(sprite, Leaf):
                if sprite.contents == "kiss" and sprite.full:
                    BoxKiss(Rect(sprite.rect.left, sprite.rect.top - 32, 32, 32))
                    sprite.full = False
                    sprite.image = sprite.images[4]
                if sprite.contents == "heart" and sprite.full:
                    Heart(Rect(sprite.rect.left, sprite.rect.top - 32, 32, 32))
                    sprite.full = False
                    sprite.image = sprite.images[4]
...
class Platform_Tree(Collidable):
...
class Platform_Tree_Mid(Collidable):
     def __init__(self, pos, l, r):
        Collidable.__init__(self, self.groups)
        self.rect = self.image.get_rect(topleft = pos)
        self.on_left = l
...
class Platform_Tree_lBranch(Collidable):
     def __init__(self, pos, l, r):
        Collidable.__init__(self, self.groups)
        self.rect = self.image.get_rect(topleft = pos)
        self.on_left = l
...
class Platform_Tree_rBranch(Collidable):
     def __init__(self, pos, l, r):
        Collidable.__init__(self, self.groups)
        self.rect = self.image.get_rect(topleft = pos)
        self.on_left = l
...
class Platform_Tree_lRoot(Collidable):
     def __init__(self, pos, l, r):
        Collidable.__init__(self, self.groups)
        self.rect = self.image.get_rect(topleft = pos)
        self.on_left = l
...
class Platform_Tree_rRoot(Collidable):
     def __init__(self, pos, l, r):
        Collidable.__init__(self, self.groups)
        self.rect = self.image.get_rect(topleft = pos)
        self.on_left = l
...
class Platform_Tree_R(Collidable):
     def __init__(self, pos, l, r):
        Collidable.__init__(self, self.groups)
        self.rect = self.image.get_rect(topleft = pos)
        self.on_left = l
...
class Platform_Tree_L(Collidable):
     def __init__(self, pos, l, r):
        Collidable.__init__(self, self.groups)
        self.rect = self.image.get_rect(topleft = pos)
        self.on_left = l
...
class Platform_Tree_TopL(Collidable):
     def __init__(self, pos, l, r):
        Collidable.__init__(self, self.groups)
        self.rect = self.image.get_rect(topleft = pos)
        self.on_left = l
...
class Platform_Tree_TopR(Collidable):
     def __init__(self, pos, l, r):
        Collidable.__init__(self, self.groups)
        self.rect = self.image.get_rect(topleft = pos)
        self.on_left = l
...
class Platform_Tree_TopMid(Collidable):
     def __init__(self, pos, l, r):
        Collidable.__init__(self, self.groups)
        self.rect = self.image.get_rect(topleft = pos)
        self.on_left = l
...
class Feet(Collidable):
    def __init__(self, pos, type="feet"):
        Collidable.__init__(self, self.groups)
        if type == "feet":
            self.left_images = self.left_images1
        self.right_images = []
        for i in self.left_images:
            self.right_images.append(i)
...
# for big pipes
class FeetBig(Collidable):
    def __init__(self, pos, type="feetbig"):
        Collidable.__init__(self, self.groups)
        if type == "feetbig":
            self.left_images = self.left_images1
        self.right_images = []
...
class Baddie(Collidable):                            # I am almost sure there something wrong here |
    def __init__(self, pos, type="lock"):                                                     # V
        Collidable.__init__(self, self.groups)
        if type == "lock":
            self.left_images = self.left_images1
        elif type == "kiss":
...
class BoxKiss(Collidable):
    ...
    def update(self):
        ...
        if self.timeleft == 0:
            self.kill()
            load_sound("kiss.ogg").play()
            KissDie(self.rect.center)
        self.frame += 1
        self.image = self.images[self.frame/6%4]

class KissDie(Collidable):
    def __init__(self, pos):
        Collidable.__init__(self, self.groups) 
        self.image = self.images[0]
        self.rect = self.image.get_rect(center = pos)
