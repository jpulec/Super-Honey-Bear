        ...
        for y in range(self.level.get_height()):
            ...
            for x in range(self.level.get_width()):
                ...
                if color == (255, 200, 0, 255):
                    Logs((self.x*32, self.y*32))
                if color == (127, 51, 0, 255):
                    Leaf((self.x*32, self.y*32), "kiss")
                if color == (0, 74, 127, 255):
                    l=r=False
                    tile = "1"
                    if self.get_at(0, -1) != (0, 74, 127, 255):
                        tile = "2"
                    if self.get_at(-1, 0) != (0, 74, 127, 255):
                        l=True
                    if self.get_at(1, 0) != (0, 74, 127, 255):
                        r=True
                    Platform_Tree((self.x*32, self.y*32), l, r)
                    
                if color == (121, 205, 4, 255):
                    l=r=False
                    tile = "1"
                    if self.get_at(0, -1) != (121, 205, 4, 255):
                        tile = "2"
                    if self.get_at(-1, 0) != (121, 205, 4, 255):
                        l=True
                    if self.get_at(1, 0) != (121, 205, 4, 255):
                        r=True
                    Platform_Tree_Mid((self.x*32, self.y*32), l, r)
                    
                if color == (117, 199, 4, 255):
                    l=r=False
                    tile = "1"
                    if self.get_at(0, -1) != (117, 199, 4, 255):
                        tile = "2"
                    if self.get_at(-1, 0) != (117, 199, 4, 255):
                        l=True
                    if self.get_at(1, 0) != (117, 199, 4, 255):
                        r=True
                    Platform_Tree_lBranch((self.x*32, self.y*32), l, r)
                
                if color == (120, 204, 4, 255):
                    l=r=False
                    tile = "1"
                    if self.get_at(0, -1) != (120, 204, 4, 255):
                        tile = "2"
                    if self.get_at(-1, 0) != (120, 204, 4, 255):
                        l=True
                    if self.get_at(1, 0) != (120, 204, 4, 255):
                        r=True
                    Platform_Tree_rBranch((self.x*32, self.y*32), l, r)
                    
                if color == (113, 191, 4, 255):
                    l=r=False
                    tile = "1"
                    if self.get_at(0, -1) != (113, 191, 4, 255):
                        tile = "2"
                    if self.get_at(-1, 0) != (113, 191, 4, 255):
                        l=True
                    if self.get_at(1, 0) != (113, 191, 4, 255):
                        r=True
                    Platform_Tree_lRoot((self.x*32, self.y*32), l, r)
                    
                if color == (113, 188, 4, 255):
                    l=r=False
                    tile = "1"
                    if self.get_at(0, -1) != (113, 188, 4, 255):
                        tile = "2"
                    if self.get_at(-1, 0) != (113, 188, 4, 255):
                        l=True
                    if self.get_at(1, 0) != (113, 188, 4, 255):
                        r=True
                    Platform_Tree_rRoot((self.x*32, self.y*32), l, r)
                    
                if color == (255, 8, 159, 255):
                    Platform_Tree_R((self.x*32, self.y*32), False, False)
                if color == (255, 8, 188, 255):
                    Platform_Tree_L((self.x*32, self.y*32), False, False) 
                if color == (255, 8, 78, 255):
                    Platform_Tree_TopL((self.x*32 + 29, self.y*32), False, False)
                if color == (255, 8, 153, 255):
                    Platform_Tree_TopR((self.x*32, self.y*32), False, False)
                if color == (255, 8, 174, 255):
                    Platform_Tree_TopMid((self.x*32, self.y*32), False, False) 
                if color == (240, 96, 0, 255):
                    PB((self.x*32, self.y*32-32))
                if color == (91, 127, 0, 255):
                    Can((self.x*32, self.y*28))
                if color == (63, 127, 98, 255):
                    Firebowser((self.x*32, self.y*32))
                if color == (87, 0, 127, 255):
                    Cloud((self.x*32, self.y*32))
                if color == (127, 0, 55, 255):
                    Leaves((self.x*32, self.y*32))
                if color == (80, 63, 127, 255):
                    Castle((self.x*32, self.y*22))
                if color == (255, 233, 127, 255):
                    Hill((self.x*32, self.y*29))
                if color == (0, 0, 255, 255):
                    Baddie((self.x*32 + 2, self.y*32 + 4), "lock")
                if color == (0, 255, 255, 255):
                    Baddie((self.x*32 + 1, self.y*32 + 2), "kiss")
                ...
                if color == (0, 127, 70, 255):
                    Leaf((self.x*32, self.y*32), "heart")
                if color == (178, 0, 255, 255):
                    CanBig((self.x*32, self.y*25))
                ...
                if color == (72, 0, 255, 255):
                    FeetBig((self.x*32.23, self.y*27.8 + 2), "feet2")
