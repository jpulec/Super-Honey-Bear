...
def Help(screen):
    ...
    "Jump: Z key",
    "Return: Esc = return",
    "Note: Avoid Broken Hearts, and stomp",
    "them out by jumping on top of them",
    "Avoid Cold Feet",
...
class Menu(object):    
    ...
    def main_loop(self):
        while 1:
            ...
            ren = self.font.render("For the best Bear in the world!", 1, (255, 255, 255))
            self.screen.blit(ren, (320-ren.get_width()/2, 70))

            ren = self.font2.render("Super Honey", 1, (255, 255, 255))
            self.screen.blit(ren, (320-ren.get_width()/2, 180))

            ren = self.font2.render("Bear", 1, (255, 255, 255))
